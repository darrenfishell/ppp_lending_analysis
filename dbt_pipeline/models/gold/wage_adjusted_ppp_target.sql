...
FROM silver.county_level_ppp_loans pp
JOIN bronze.census_ppp_county_bridge b
ON pp.project_county_name = b.project_county_name
AND pp.state_name = b.state_name
JOIN silver.county_census_2019 c
ON b.area_fips = c.area_fips
JOIN silver.county_qcew_summary q
ON c.area_fips = q.area_fips --3139
JOIN silver.county_2016_election_results e
