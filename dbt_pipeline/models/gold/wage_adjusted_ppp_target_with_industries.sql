SELECT
	...
	q.avg_annual_pay as avg_annual_pay,
	q.lq_avg_annual_pay as lq_avg_annual_pay,
	...
	c.hispanic_population / c.total_population as hispanic_pop_share,
	e.republican / e.total as trump_vote_share,
	w.* EXCLUDE (area_fips)
...
JOIN {{ ref("county_qcew_sector_wages") }} w
ON c.area_fips = w.area_fips
